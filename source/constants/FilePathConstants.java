...
public final class FilePathConstants {
    ...
    public static final String FORMATTING_FILE_NAME = "formatting.json";
    public static final String CONFIG_FILE = String.valueOf(Path.of(CONFIG_DIRECTORY, "configuration.json"));
    public static final String FORMATTING_FILE = String.valueOf(Path.of(CONFIG_DIRECTORY, FORMATTING_FILE_NAME));
